...
public class WDApplication extends Application {
    ...
    public static HttpProxyCacheServer getProxy(Context context,FileNameGenerator fileNameGenerator) {
        WDApplication app = (WDApplication) context.getApplicationContext();
        return app.proxy == null ? (app.proxy = app.newProxy(fileNameGenerator)) : app.proxy;
    }

    private HttpProxyCacheServer newProxy(FileNameGenerator fileNameGenerator) {
